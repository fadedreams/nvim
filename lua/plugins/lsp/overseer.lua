return {
  {
    ...
    keys = {
      ...
      { "<leader>cg", "<Cmd>OverseerRunCmd go run %:p<CR>", desc = "Run Go Script" },
      { "<leader>cp", "<Cmd>OverseerRunCmd python3 %:p<CR>", desc = "Run Python Script" },
      { "<leader>ch", "<Cmd>OverseerRunCmd php %:p<CR>", desc = "Run PHP Script" },
