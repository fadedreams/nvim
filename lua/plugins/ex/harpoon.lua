...
local keys = {
    ...
    sel_f1 = "<localleader>1",
    sel_f2 = "<localleader>2",
    sel_f3 = "<localleader>3",
    sel_f4 = "<localleader>4",
    sel_f5 = "<localleader>5",
    sel_f6 = "<localleader>6",
    sel_f7 = "<localleader>7",
    sel_f8 = "<localleader>8",
    sel_f9 = "<localleader>9",
}
