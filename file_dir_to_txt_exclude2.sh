...
default_exclude_dirs=("node_modules" "target" ".git" "resources" ".idea" ".vscode" "__pycache__" "venv" ".venv" ".mypy_cache" ".pytest_cache" "build" "dist" "out" "docs" "venv" "env"  "__pycache__")
# Default files to exclude if none provided
default_exclude_files=("LICENSE" "file_dir_to_txt_exclude.sh" ".gitignore" "serverall.js" ".env" "all.txt" "go.sum" "package-lock.json" "yarn.lock" ".next" ".env.local" ".env.development.local" ".env.production.local" ".env.test.local" ".env.development" ".env.production" ".env.test" ".DS_Store" "Thumbs.db" "desktop.ini" "*.swp" "*.swo" "*.swn" "*.swm" "*.swl" "*.swk" "*.swj" "*.swh" "*.swc" "*.swb" "*.swo" "*.swn" "*.swm" "*.swl" "*.swk" "*.swj" "*.swh" "*.swc" "*.swb" "*.swp" "*.swo" "*.swn" "*.swm" "*.swl" "*.swk" "*.swj" "*.swh" "*.swc" "*.swb")

# Use command-line arguments for exclusions, fall back to defaults if none provided
